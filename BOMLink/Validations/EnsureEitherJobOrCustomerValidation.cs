...
namespace BOMLink.Validations {
    public class EnsureEitherJobOrCustomerValidation : ValidationAttribute {
        protected override ValidationResult IsValid(object value, ValidationContext validationContext) {
            ...
            if ((jobIdValue == null && customerIdValue == null) || (jobIdValue != null && customerIdValue != null)) {
                return new ValidationResult("You must select either a Job or a Customer, but not both.");
            }
